...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2021 a las 19:24:10
...
INSERT INTO `cart` (`id`, `id_user`, `id_prod`, `cantidad`) VALUES
(1, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 3, 4),
(2, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 2, 3),
(3, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 5, 6),
(4, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 6, 1),
(5, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 9, 1),
(6, 'fe8688e1ee90b25d97f326a0b9a0af5a0dc195d21e1ae70bdd21398c26661d9d', 11, 6);

--
-- Disparadores `cart`
--
DELIMITER $$
CREATE TRIGGER `no_cero_cart` 
BEFORE UPDATE ON `cart` 
FOR EACH ROW BEGIN
	  IF new.cantidad <= 0 THEN
      SQLSTATE
    	DELETE FROM cart WHERE id_user=old.id_user AND id_prod=old.id_prod;
    END IF ;
END$$
DELIMITER ;
